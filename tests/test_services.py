...
class TestRoleServiceFull:
    ...
    async def test_create_role_success(self):
        ...
        with patch.object(service.role_repository, 'get_by_name', new_callable=AsyncMock) as mock_get_by_name:
            with patch.object(service.role_repository, 'create', new_callable=AsyncMock) as mock_create:
    ...
    async def test_get_role_by_id_success(self):
        ...
        service = RoleService()
        with patch.object(service.role_repository, 'get_by_id', new_callable=AsyncMock) as mock_get:
    ...
    async def test_get_all_roles(self):
        ...
        service = RoleService()
        with patch.object(service.role_repository, 'get_all', new_callable=AsyncMock) as mock_get_all:
    ...
    async def test_get_role_by_name(self):
        ...
        service = RoleService()
        with patch.object(service.role_repository, 'get_by_name', new_callable=AsyncMock) as mock_get_name:
    ...
    async def test_update_role_success(self):
        ...
        service = RoleService()
        with patch.object(service.role_repository, 'update', new_callable=AsyncMock) as mock_update:
    ...
    async def test_delete_role_success(self):
        ...
        service = RoleService()
        with patch.object(service, 'get_role_by_id', new_callable=AsyncMock) as mock_get:
            with patch.object(service.role_repository, 'delete', new_callable=AsyncMock) as mock_delete:
    ...
    async def test_assign_permissions_success(self):
        ...
        service = RoleService()
        with patch.object(service.role_repository, 'update', new_callable=AsyncMock) as mock_update:
            mock_update.return_value = Role(name="editor", permission_ids=["perm1", "perm2"])
            result = await service.assign_permissions_to_role("role123", ["perm1", "perm2"])
