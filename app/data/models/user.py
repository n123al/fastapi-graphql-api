...
class UserProfile(BaseModel):
    ...
    date_of_birth: Optional[datetime] = Field(default=None, description="User's date of birth")
...
class User(BaseDataModel):
    ...
    profile: UserProfile = Field(default_factory=UserProfile, description="User profile information")
    ...
    failed_login_attempts: int = Field(default=0, description="Number of failed login attempts (compat)")
    locked_until: Optional[datetime] = Field(default=None, description="Account lock expiration time")
    ...
    permission_ids: List[str] = Field(default_factory=list, description="User's direct permission IDs")
