...
class BaseRepository(Generic[T]):
    ...
    async def create(self, model: T) -> T:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to create {self.collection_name}: {str(e)}")
    ...
    async def get_by_id(self, record_id: str) -> Optional[T]:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to retrieve {self.collection_name}: {str(e)}")
    ...
    async def update(self, record_id: str, update_data: Dict[str, Any]) -> Optional[T]:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to update {self.collection_name}: {str(e)}")
    ...
    async def delete(self, record_id: str) -> bool:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to delete {self.collection_name}: {str(e)}")
    ...
    async def count(self, **filters: Any) -> int:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to count {self.collection_name}: {str(e)}")
...
class UserRepository(BaseRepository['User']):
    ...
    async def get_by_username(self, username: str) -> Optional['User']:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to retrieve user by username: {str(e)}")
    ...
    async def get_by_email_or_username(self, identifier: str) -> Optional['User']:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to retrieve user by email or username: {str(e)}")
...
class PermissionRepository(BaseRepository['Permission']):
    ...
    async def get_by_resource_action(self, resource: str, action: str) -> Optional['Permission']:
        ...
        """
        try:
            doc = await self.collection.find_one({"resource": resource, "action": action})
            if doc:
                prepared_data = self._prepare_from_storage(doc)
                return self.model_class(**prepared_data)
            return None
    ...
    async def get_by_name(self, name: str) -> Optional['Permission']:
        try:
            ...
            raise DatabaseConnectionError(f"Failed to retrieve permission by name: {str(e)}")
...
class GroupRepository(BaseRepository['Group']):
    ...
    async def get_by_member(self, user_id: str, limit: int = 100) -> List['Group']:
        ...
        try:
            ...
            raise DatabaseConnectionError(f"Failed to retrieve groups by member: {str(e)}")
