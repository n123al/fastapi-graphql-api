...
class AuthenticationService(BaseService[User]):
    ...
    async def register_user(self, registration_data: Dict[str, Any]) -> User:
        ...
        self._log_operation("user_registered", {
    ...
    async def change_password(self, user_id: str, current_password: str, new_password: str) -> bool:
        ...
        if updated_user:
            self._log_operation("password_changed", {
                "user_id": user_id,
    ...
    async def set_password_with_token(self, token: str, new_password: str) -> bool:
        try:
            ...
            if updated_user:
                self._log_operation("password_set_via_token", {
                    "user_id": user_id,
                    "timestamp": datetime.now(timezone.utc).isoformat()
                })
                return True
    ...
    async def _handle_failed_login(self, user: User) -> None:
        ...
        # Update user record
        await self.user_repository.update(str(user.id), {
