...
from app.core.constants import DEFAULT_ROLES, DEFAULT_PERMISSIONS, DEFAULT_GROUPS, MONGODB_SETTINGS
...
class MotorDatabaseManager:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self.client = AsyncIOMotorClient(
                ...
                **cast(Dict[str, Any], client_kwargs)
            )
            ...
            logger.info("MongoDB connected successfully with Motor driver", database=settings.DATABASE_NAME)
    ...
    async def _initialize_repositories(self) -> None:
        ...
        from app.data import UserRepository, RoleRepository, PermissionRepository, GroupRepository
    ...
    async def _create_default_roles(self) -> None:
        ...
        for role_name, role_data in DEFAULT_ROLES.items():
            ...
            if not existing:
                ...
                logger.debug("Created default role", name=role_name, permission_count=len(permissions))
        ...
        try:
            ...
            for collection_name in collections:
                try:
                    ...
                    logger.warning(f"Failed to get stats for {collection_name}", error=str(e))
