...
from app.graphql.auth import require_permission, require_any_permission, require_authentication
...
class PermissionQueries:
    ...
    @require_permission("permissions:read")
    async def permissions_by_resource(self, info: Info, resource: str) -> List[Permission]:
        """
        ...
        try:
            ...
            collection = motor_db_manager.database["permissions"]
            docs = await collection.find({"resource": resource, "is_active": True}).to_list(None)
